...
#ifdef __GNUC__ 
static const QString FMOD_ErrorString(FMOD_RESULT errcode) __attribute__((unused));
#endif

static const QString FMOD_ErrorString(FMOD_RESULT errcode)
{
    switch (errcode)
    {
/*$ preserve end $*/
        ...
        case FMOD_ERR_FORMAT:                    return "Unsupported file, audio format or needs password for decryption.";
